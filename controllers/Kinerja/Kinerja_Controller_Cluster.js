...
import Isu_Model from "../../models/cluster/isumodel.js";
import TemuanBpk_Model from "../../models/cluster/temuanbpk.js";
import TrenBulanan_Model from "../../models/cluster/trenbulanan.js";
import TrenDukman_Model from "../../models/cluster/trendukman.js";
import TrenJenbel_Model from "../../models/cluster/trenjenbel.js";
import db from "../../config/Database3.js";
import TemuanBpkDetail_Model from "../../models/cluster/temuanbpkdetail.js";
import { v4 as uuidv4 } from "uuid";
import Output_Model from "../../models/cluster/output.js";
import OutputDetail_Model from "../../models/cluster/outputdetail.js";
import TrenSdana_Model from "../../models/cluster/trensdana.js";
import Ikpa_Model from "../../models/cluster/ikpa.js";
import TrenUptup_Model from "../../models/cluster/trenduptup.js";

export const simpanIsuCluster = async (req, res) => {
  ...
  const { thang, periode, cluster, prov, user } = data;
  ...
  const isuData = [
    { isu: input1, username: user, thang, kdcluster: cluster, periode, prov },
    { isu: input2, username: user, thang, kdcluster: cluster, periode, prov },
    { isu: input3, username: user, thang, kdcluster: cluster, periode, prov },
    { isu: input4, username: user, thang, kdcluster: cluster, periode, prov },
  ];
  ...
  res.json({ msg: "Data Insert Berhasil" + createdIsu });
};

export const simpanTrenCluster = async (req, res) => {
...
export const simpanTemuanCluster = async (req, res) => {
  const {
    temuan,
    nilai,
    input3,
...
export const getDatacluster = async (req, res) => {
...
export const chartcluster = async (req, res) => {
  const queryParams = req.query.queryParams;
...
export const hapustemuanCluster = async (req, res) => {
  try {
...
export const simpanOutputCluster = async (req, res) => {
  const {
    namaoutput,
    catatan,
    tahun1,
...
export const hapusoutputcluster = async (req, res) => {
  try {
...
export const simpanIkpaCluster = async (req, res) => {
  try {
...
export const hapusikpacluster = async (req, res) => {
  try {
